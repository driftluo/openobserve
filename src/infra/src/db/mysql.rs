...
fn connect(readonly: bool, ddl: bool) -> Pool<MySql> {
    ...
    // 1. Disable options that cause subquery in SET sql_mode
    //    OceanBase doesn't support: SET sql_mode=(SELECT CONCAT(@@sql_mode, '...'))
    // 2. Use utf8mb4_general_ci collation instead of utf8mb4_unicode_ci
    //    OceanBase only supports utf8mb4_general_ci and utf8mb4_bin for utf8mb4 charset
    if MetaStore::from(cfg.common.meta_store.as_str()) == MetaStore::OceanBase {
        db_opts = db_opts
            .charset("utf8mb4")
